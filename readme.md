# Bando de dados
Repositório de provas antigas da Disciplina **Bando de dados** do curso de **Tecnologia em Sistemas de Computaćao** da **UFF** ministrado através do **CEDERJ**.
...
`git clone https://github.com/compcederj/banco-de-dados.git`
...
`git clone git@github.com:compcederj/banco-de-dados.git`
...
# Bando de dados
Repositório de provas antingas da Disciplina **Bando de dados** do curso de **Tecnologia em Sistemas de Computaçao** da **UFF** ministrado através do **CEDERJ**.
